...
format_list_srv_output_test() ->
    Input = list_server_output(),
    ServerList = er_output:format_list_srv_output(Input),
    Srv1 = lists:nth(1, ServerList),
    Srv2 = lists:nth(2, ServerList),
    ?assertEqual("test2", dict:fetch("name", Srv1)),
    ?assertEqual("test1", dict:fetch("name", Srv2)).
...
list_server_output() ->
    "{\"servers\":[{\"progress\":100,\"id\":577542,\"imageId\":55,\"flavorId\":1,\"status\":\"ACTIVE\",\"name\":\"test1\",\"hostId\":\"d762c1150035ca023616ee23a6a693bc\",\"addresses\":{\"public\":[\"184.106.82.33\"],\"private\":[\"10.180.161.20\"]},\"metadata\":{}},{\"progress\":100,\"id\":577543,\"imageId\":55,\"flavorId\":1,\"status\":\"ACTIVE\",\"name\":\"test2\",\"hostId\":\"64d47a0b999a363151f1481ae758ac10\",\"addresses\":{\"public\":[\"184.106.82.34\"],\"private\":[\"10.180.160.233\"]},\"metadata\":{}}]}".
